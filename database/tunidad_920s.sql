...
--
-- Servidor: localhost
-- Tiempo de generación: 13-12-2024 a las 02:17:37
...
--
-- Volcado de datos para la tabla `causa_pago`
--

INSERT INTO `causa_pago` (`id`, `titulo`, `descripcion`, `fecha_inicio`, `fecha_fin`, `valor`, `porcentaje_mora_diario`, `id_tipo_causa_pago`) VALUES
(1, 'CANON ADMINISTRACION OCTUBRE 2024', 'Pago aministracion unidad xxx del mes de octubre del 2024', '2024-10-01', '2024-10-31', 250000, 1, 1);
...
--
-- Volcado de datos para la tabla `detalle_inmueble`
--

INSERT INTO `detalle_inmueble` (`id`, `id_inmueble`, `estado`, `registro`) VALUES
(1, 1, 'inactivo', '2024-10-17'),
(2, 1, 'activo', '2024-10-18');
...
--
-- Volcado de datos para la tabla `detalle_inmueble_pago`
--

INSERT INTO `detalle_inmueble_pago` (`id`, `id_detalle_inmueble`, `id_causa_pago`, `id_persona`, `valor`, `fecha`, `soporte`, `estado`) VALUES
(1, 2, 1, 14, 200000, '2024-10-18', '', 'registrado');
...
CREATE TABLE `detalle_inmueble_persona` (
  `id` int(11) NOT NULL,
  `id_detalle_inmueble` int(11) NOT NULL,
  `ip_persona` int(11) NOT NULL,
  `tipo_relacion` enum('propietario','habitante','arrendatario','servicio') NOT NULL DEFAULT 'habitante',
  `estado` enum('activo','inactivo') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `detalle_inmueble_persona`
--

INSERT INTO `detalle_inmueble_persona` (`id`, `id_detalle_inmueble`, `ip_persona`, `tipo_relacion`, `estado`) VALUES
(1, 1, 3, 'propietario', 'activo'),
(2, 1, 11, 'habitante', 'activo'),
(3, 1, 12, 'servicio', 'inactivo'),
(4, 1, 13, 'servicio', 'activo'),
(5, 2, 14, 'propietario', 'activo');
...
INSERT INTO `inmueble` (`id`, `nomenclatura`, `m2`, `id_tipo_inmueble`) VALUES
(1, 'C1', '160', 1),
(2, 'C2', '150', 1),
(3, 'A1', '70', 2),
(4, 'P1', '20', 3);
...
CREATE TABLE `persona` (
  ...
  `tipo_identificacion` enum('cc','pasaporte','extranjeria') NOT NULL,
...
INSERT INTO `persona` (`id`, `nombre`, `apellido`, `genero`, `fecha_nacimiento`, `tipo_identificacion`, `identificacion`, `telefono`, `correo`, `id_municipio`, `direccion`, `zip`) VALUES
(1, 'Gustavo', 'Rodriguez', 'm', '2000-02-01', 'cc', '1061', '123123', 'garodriguez335@misena.edu.co', 679, 'calle 55 n # 123', '190001'),
(3, 'Gabriela', 'Rodriguez', 'f', '2014-10-01', 'cc', '1062', '123123', 'garodriguez335@misena.edu.co', 150, 'calle 55 n # 123', '190001'),
(4, 'Jose', 'Peña', 'm', '1991-10-01', 'cc', '1063', '654', 'jose@misena.edu.co', 107, 'calle 55 n # 123', '190001'),
(8, 'Victor', 'Rojas', 'm', '1980-10-01', 'cc', '1067', '654', 'victor@misena.edu.co', 547, 'calle 55 n # 123', '190001'),
(9, 'Andres', 'Perez', 'm', '1954-10-01', 'cc', '1064', '654', 'andresp@misena.edu.co', 547, 'calle 55 n # 123', '190001'),
(10, 'Yuly', 'Espitia', 'f', '2024-10-08', 'cc', '1065', '654', 'yuly@misena.edu.co', 107, 'calle 55 n # 123', '190001'),
(11, 'Habitante1', 'Test', 'o', '2024-10-02', 'pasaporte', 'AC123123', '21123123', 'test@misena.edu.co', 547, 'calle 55 n # 123', '190001'),
(12, 'Servicio1', 'Test', 'o', '2024-10-01', 'cc', '3312321', '123123', 'ddd@misena.edu.co', 679, 'calle 55 n # 123', '190001'),
(13, 'Sericio Juan', 'test', 'o', '2024-09-04', 'extranjeria', '12312312333', '65433', '33@misena.edu.co', 679, 'calle 55 n # 123', '190001'),
(14, 'Marcela', 'Gomez', 'f', '1990-10-15', 'cc', '345345', '12312312', 'mmmm@misena.edu.co', 829, 'calle 55 n # 123', '190001'),
(15, 'Testx', 'ApellidoA', 'f', '2024-12-13', 'cc', '54333', '443312', 'prueba@p.com', 1095, 'Calle siempre viva 123', '190001');
...
--
-- Volcado de datos para la tabla `tipo_causa_pago`
--

INSERT INTO `tipo_causa_pago` (`id`, `titulo`) VALUES
(1, 'CANON MENSUAL'),
(3, 'MULTA'),
...
CREATE TABLE `tipo_inmueble` (
  ...
  `titulo` varchar(20) NOT NULL COMMENT 'Valor que permite almacenar el nombre o titulo de los tipos de inmuble a gestionar en el proyecto'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tipo_inmueble` (`id`, `titulo`) VALUES
(2, 'APTO'),
(4, 'BODEGA'),
(1, 'CASA'),
(3, 'PARQUEADERO');
...
(1, 'garodriguez335@misena.edu.co', 'Popayan123', 1, 1),
(3, 'gaby@misena.edu.co', 'Popayan123', 3, 2),
(4, 'yuly@sena.edu.co', 'qweqweqe', 10, 4),
(5, 'propietario1@test.com', 'propietario1', 3, 3),
(6, 'mmm@test.com', 'mmm123', 14, 3);
...
ALTER TABLE `causa_pago`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_tipo_causa_pago` (`id_tipo_causa_pago`);
...
ALTER TABLE `detalle_inmueble_pago`
  ...
  ADD KEY `id_causa_pago` (`id_causa_pago`),
...
ALTER TABLE `detalle_inmueble_persona`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_propiedad_inmueble` (`id_detalle_inmueble`),
  ADD KEY `ip_persona` (`ip_persona`);
...
--
ALTER TABLE `tipo_inmueble`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria auto-incrementable para almacenar los ids de los tipos de inmuebles', AUTO_INCREMENT=5;
...
--
ALTER TABLE `causa_pago`
  ADD CONSTRAINT `fk_causa_pago_tipo_causa_pago` FOREIGN KEY (`id_tipo_causa_pago`) REFERENCES `tipo_causa_pago` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_inmueble`
--
ALTER TABLE `detalle_inmueble`
  ADD CONSTRAINT `fk_detelle_inmueble_inmueble` FOREIGN KEY (`id_inmueble`) REFERENCES `inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_inmueble_pago`
--
ALTER TABLE `detalle_inmueble_pago`
  ADD CONSTRAINT `fk_detalle_inmueble_pago_causa_pago` FOREIGN KEY (`id_causa_pago`) REFERENCES `causa_pago` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_detalle_inmueble_pago_detalle_inmueble` FOREIGN KEY (`id_detalle_inmueble`) REFERENCES `detalle_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_detalle_inmueble_pago_persona` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_inmueble_persona`
--
ALTER TABLE `detalle_inmueble_persona`
  ADD CONSTRAINT `fk_detalle_inmueble_persona_detalle_inmueble` FOREIGN KEY (`id_detalle_inmueble`) REFERENCES `detalle_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_detalle_inmueble_persona_persona` FOREIGN KEY (`ip_persona`) REFERENCES `persona` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
